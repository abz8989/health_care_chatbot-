...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="HealthCare System Chatbot", bg="white", width="300", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login",bg="red",height="2", width="20", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.lblTeam1=Label(self, text="", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.btnRegister=Button(self, text="Register",bg="yellow", height="2", width="20", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam1=Label(self, text="", bg="white", width = "250", height = "3", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam=Label(self, text="Made by:", bg="slateblue4", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="TANU SHREE", bg="pink", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below", bg="red")
        self.lblMsg.pack()
        ...
        self.btnRegister=Button(self, text="Register", width=20, height=1, bg="blue", command=self.register_user)
        self.btnRegister.pack()
